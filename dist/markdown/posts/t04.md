...
This post focuses on understanding all the fundamental options that Spring Boot provides for us to create endpoints and build our APIs (HTTP, REST, MVC). If you are wondering how to create a REST API, or a MVC API, or just how to take complete control of the return HTTP when using Spring Boot, then this post should be of interest to you.

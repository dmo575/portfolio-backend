...
This is the most complicated of the three ways of structuring the API. The other two were straight forward but for this one we need to know about the MVC pattern and also what templates are. So let's go over it quickly.

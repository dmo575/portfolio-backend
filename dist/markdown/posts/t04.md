...
- **HTTP** *-> Writting endpoints for HTTP*
- **REST** *-> Writting endpoints for REST*
- **MVC** *-> Writting endpoints for MVC*
...
public ResponseEntity<String> someExceptionHandler(SomeException ex) {
    BEHOLD THIS THING, ITS NAME IS SEH-3000
}
```

...
This post focuses on understanding all the options that Spring Boot provides for us to create endpoints and build our APIs (HTTP, REST, MVC). If you are wondering how to set things tup for your REST API, or your MVC API, or just want to know how to take complete control of the return HTTP when using Spring Boot, then this post should be of interest to you.

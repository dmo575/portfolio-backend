...
- *ResponseEntity/ModelAndView* **>** *Annotations* **>** *MVC*
	...
	- **ResponseEntity/ModelAndView**: They are exclusive as you can only return one. Whenever you are returning one of these, whatever you else you have (like `@ResponseBody`) wont count.

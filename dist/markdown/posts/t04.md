...
Alternatively, we can use ResponseBody's static methods for common responses like 200 OK. The following code achieves a similar result than the previous one:
